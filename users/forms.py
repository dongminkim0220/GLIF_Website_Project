...
class ApplicantEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels =  {
            ...
            "willyou": "(1) 최소 2학기 이상 연속으로 활동 하셔야 합니다. 또한 격주 단위꼴로 금요일마다 진행되는 세션에 참여가 가능해야 합니다.   그렇지 않으면 정회원 등록이 불가능합니다. 가능하십니까? (2) 또한 추가적으로, 3월 9일(토)에 있을 면접, 3월 11일(월)에 있을 새 학회원 대상 설명회, 3월 15일(금)에 있을 MT에는 참석이 가능해야합니다. 위 사항과 관련해 특이사항이 있다면 적어주세요.",
